...
// Import your logo image (adjust the file path and extension as needed)
          ...
          {roles.map((role) => {
            ...
            return (
              <button
                ...
                className={`flex-1 py-2 px-1 rounded-lg flex items-center justify-center gap-1.5 transition-all text-xs font-semibold ${
                  isSelected
